...
function AppInner() {
  ...
  const [aboutUsData, setAboutUsData] = useState<CMSAboutUs | null>(null);
  const [groupConcerns, setGroupConcerns] = useState<CMSGroupConcern[]>([]);
      ...
      <div className="relative z-10">
        ...
        {currentView === 'home' && (
          <main>
            ...
            {siteSettings?.showVirtualConfigurator !== false && <InteractiveTour />}
            ...
            {/* Landowners Joint Venture Feasibility Portal */}
            <PartnershipPortal />
          </main>
        )}

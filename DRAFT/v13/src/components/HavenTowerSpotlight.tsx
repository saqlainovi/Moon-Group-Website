          ...
          <div className={`lg:col-span-5 rounded-2xl p-6 md:p-8 border space-y-6 flex flex-col justify-between shadow-xl ${
            ...
            <div>
              <div className={`flex items-center justify-between border-b pb-4 mb-6 ${isDark ? 'border-neutral-800' : 'border-stone-200'}`}>
                <div>
                  <span className={`text-xs font-mono uppercase tracking-wider ${isDark ? 'text-amber-400' : 'text-[#EE1B24]'}`}>Project Status</span>
                ...
                <div className="text-right">
                  <span className={`text-xs font-mono uppercase tracking-wider ${isDark ? 'text-neutral-400' : 'text-stone-500'}`}>Launch Rate</span>
                  <p className={`text-lg font-bold ${isDark ? 'text-amber-300' : 'text-[#EE1B24]'}`}>Tk 2.2 - 5.5 Cr</p>
                </div>
              </div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <p className={`text-sm ${isDark ? 'text-neutral-200' : 'text-stone-700'}`}>
                    <strong className={isDark ? 'text-white' : 'text-stone-900'}>Location:</strong> Plot 01, Section 12, Mirpur / Prime Location, Dhaka
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <Building className={`w-5 h-5 flex-shrink-0 mt-0.5 ${isDark ? 'text-amber-400' : 'text-[#EE1B24]'}`} />
                  <p className={`text-sm ${isDark ? 'text-neutral-200' : 'text-stone-700'}`}>
                    <strong className={isDark ? 'text-white' : 'text-stone-900'}>Apartment Sizes:</strong> 1,850 Sft - 3,600 Sft (Single & Duplex)
                  </p>
                </div>
              </div>
              ...
              <ul className={`space-y-2.5 text-sm ${isDark ? 'text-neutral-300' : 'text-stone-700'}`}>
                <li className="flex items-center gap-2.5">
                  ...
                  <span>25-Story Iconic Landmark Architecture</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                  <span>Grand Double-Height Entrance Atrium Lobby</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                  <span>Rooftop Sky Infinity Pool & Botanical Lounge</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                  <span>Zone-4 Earthquake Resistant Certified Structure</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                  <span>High-Speed Intelligent Elevators & 100% Power Backup</span>
                </li>
                <li className="flex items-center gap-2.5">
                  <Check className="w-4 h-4 text-emerald-500 flex-shrink-0" />
                  <span>Smart Home Automation with Biometric Security</span>
                </li>
              </ul>
            </div>
            ...
            <div className={`pt-4 border-t space-y-3 ${isDark ? 'border-neutral-800' : 'border-stone-200'}`}>
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-black font-bold py-3 px-4 rounded-xl text-sm transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full bg-red-600 hover:bg-red-500 text-white font-bold py-3 px-4 rounded-xl text-sm transition-all flex items-center justify-center gap-2 shadow-lg shadow-red-600/20 cursor-pointer"
                >
              ...
              <a
                ...
                className={`w-full font-mono text-xs py-2.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2 border ${
                  isDark 
              ...
              >
                <Phone className={`w-3.5 h-3.5 ${isDark ? 'text-amber-400' : 'text-[#EE1B24]'}`} />
                <span>Sales Hotline: +88 01313-401405</span>
              </a>
            </div>

...
export default function AboutUs({ aboutData }: AboutUsProps) {
  ...
  const targetYear = aboutData?.yearFounded ?? 1989;
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-mono text-xs tracking-[0.2em] text-[#FF4A4F] uppercase font-bold">
                {aboutData?.tagline || "A Legacy Since 1989"}
              </span>
            </div>
            ...
            <div className={`space-y-6 text-base leading-relaxed font-light transition-colors duration-300 ${
              ...
              <p>
                {aboutData?.paragraph1 || "Moon Builders is the construction and real estate arm of Moon Group of Industries, founded in 1989 under the visionary leadership of Al-haj Mizanur Rahman."}
              </p>

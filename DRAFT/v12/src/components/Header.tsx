...
import { Menu, X, Phone, CalendarRange, Sun, Moon } from 'lucide-react';
        ...
        <div className="max-w-[1360px] mx-auto px-6 sm:px-10 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#EE1B24] hover:bg-[#CC121A] text-white font-bold text-xs tracking-widest uppercase transition-colors duration-300 flex items-center space-x-2 rounded-sm cursor-pointer shadow-md"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 font-mono text-xs tracking-widest uppercase font-bold text-[#EE1B24] hover:text-white hover:bg-[#FF4A4F] transition-all duration-300 py-3 cursor-pointer border border-[#EE1B24]/30 bg-transparent rounded-sm px-4.5"
            >

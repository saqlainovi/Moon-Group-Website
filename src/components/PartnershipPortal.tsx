...
export default function PartnershipPortal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (!isQuotaExceeded()) {
        await withTimeout(setDoc(doc(db, 'partnerships', submissionId), submission), 2000, true);
      }
    } catch (error) {
      markQuotaExceeded();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <h2 className="font-serif text-3xl sm:text-5xl font-bold tracking-tight text-white mb-6 leading-tight">
              Partner with Moon Bangladesh
            </h2>
            <div className="h-[2px] w-20 bg-gold-500 mb-8" />
            
            <p className="text-slate-300 font-sans text-base font-light leading-relaxed mb-10">
              Joint-venturing with Moon Group Bangladesh converts your highly valued property into a magnificent, iconic residential or commercial tower. We merge financial integrity, aesthetic elegance, and unyielding structural engineering.
            </p>

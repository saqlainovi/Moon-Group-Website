...
export default function HavenTowerSpotlight({ havenProperty, siteSettings, onSelectProperty, onOpenBookingModal, showBanner = true }: HavenTowerSpotlightProps) {
  ...
  const defaultStaticImages = [
    { url: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?auto=format&fit=crop&w=1200&q=80', caption: 'Panoramic Front Elevation & Architectural Skyline View' },
    { url: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=1200&q=80', caption: 'Front Tower Elevation & Modern Facade' },
    { url: 'https://images.unsplash.com/photo-1579725942955-4d8377f8c66a?auto=format&fit=crop&w=1200&q=80', caption: 'Rooftop Sky Deck & Architectural Lighting Perspective' },
    { url: 'https://images.unsplash.com/photo-1428360905656-e63a3fa0400b?auto=format&fit=crop&w=1200&q=80', caption: 'Luxury Exterior Architecture & Glass Facade' },
    { url: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=1200&q=80', caption: 'Wide Landscape Perspective & Surrounding Greenery' },
    { url: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?auto=format&fit=crop&w=1200&q=80', caption: 'Grand Double-Height Entrance Atrium Lobby' },
    { url: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=80', caption: 'Executive Suite Balcony & Panoramic Vistas' },
    { url: 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?auto=format&fit=crop&w=1200&q=80', caption: 'Detailed Architectural Craftsmanship' },
    { url: 'https://images.unsplash.com/photo-1475855581690-80accde3ae2b?auto=format&fit=crop&w=1200&q=80', caption: 'Aerial Tower Elevation View' },
    { url: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1200&q=80', caption: 'Night Architectural Illumination View' },
    { url: 'https://images.unsplash.com/photo-1503387873255-3a45c55f9ea2?auto=format&fit=crop&w=1200&q=80', caption: 'Comprehensive Site Masterplan Render' }
  ];

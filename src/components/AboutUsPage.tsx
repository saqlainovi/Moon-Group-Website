        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-4 text-slate-300 font-light text-sm sm:text-base leading-relaxed">
              <p>
                Founded in 1983 under the visionary stewardship of Al-haj Mizanur Rahman, Moon Group of Industries started with a humble dream: to shape the skyline of Bangladesh with unwavering engineering precision, transparency, and architectural brilliance.
              </p>
              <p>
                Over the last 43 years, that single vision blossomed into a colossal conglomerate comprising 19 sister concerns and active representation across 11 critical sectors including steel rolling, ready-mix concrete, chemical logistics, high-density residential developments, and infrastructure leasing.
              </p>
              <p>
      ...
      <section className="bg-gradient-to-r from-red-950/20 to-neutral-950 border-t border-white/5 py-20 text-center">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <p className="text-slate-400 text-xs sm:text-sm leading-relaxed mb-8">
            Connect with Bangladesh's most trusted real estate brand today for luxury residential purchases, commercial developments, or corporate inquiries.
          </p>
          <button
